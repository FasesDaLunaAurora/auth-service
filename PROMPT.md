...
### Documento de instruções para geração completa do projeto

---

## ⚠️ Instruções de execução

Este documento é uma **especificação técnica completa e fechada** de um microsserviço de autenticação e autorização. Sua tarefa é gerar a implementação completa deste projeto, em texto, seguindo rigorosamente o que está definido abaixo.
